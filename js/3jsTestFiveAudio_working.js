...
var analyser = audioCtx.createAnalyser(); //looks at frequency data, analyser is a built in web audio API method.
var myAudio = document.getElementById('myAudio'); //audio tag on html
//var source = audioCtx.createMediaElementSource(myAudio); //creates source from file linked in html


//source.connect(analyser); //connects the audio file to the analyser method
...
//var frequencyData = new Uint8Array(analyser.frequencyBinCount); //creates an array out of the frequency data. The array has 1024 indexes, and contains the binary frequency data that goes from 0-255 depending on the audio playing.
...
var sphere, text, geometry, color, size, particles, parameters, materials = []; //variable for objects in scene
